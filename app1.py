...
# STEP 1: Create event loop FIRST
asyncio.set_event_loop(asyncio.new_event_loop())

# STEP 2: Then apply nest_asyncio
import nest_asyncio
nest_asyncio.apply()

# STEP 3: Windows fix (optional but recommended)
if sys.platform.startswith('win') and platform.system() == "Windows":
...
if __name__ == "__main__":
    try:
        ...
        # For environments like Streamlit that already run event loops
        main()
